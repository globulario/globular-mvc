 ...
 */
class AccountMenu extends Menu_1.Menu {
    // attributes.
    ...
    setAccount(account) {
        ...
        this.shadowRoot.getElementById("logout_btn").onclick = () => {
            Model_1.Model.eventHub.publish("logout_event_", {}, true);
        };
        ...
        this.shadowRoot.getElementById("profil_picture_selector").onchange = (evt) => {
            ...
            r.onload = () => {
                ...
                img.onload = () => {
                    ...
                    Model_1.Model.eventHub.publish("update_profile_picture_event_", canvas.toDataURL("image/png"), true);
