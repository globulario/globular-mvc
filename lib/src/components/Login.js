...
exports.RegisterBox = exports.LoginBox = exports.Login = void 0;
...
class LoginBox extends HTMLElement {
    ...
    connectedCallback() {
        ...
        loginBtn.onclick = (evt) => {
            ...
            Model_1.Model.eventHub.publish("login_event_", { userId: userId, pwd: pwd }, true);
        };
 ...
 * Register box
 */
class RegisterBox extends HTMLElement {
    // attributes.
    // Create the applicaiton view.
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        registerBtn.onclick = () => {
            ...
            this.parentNode.removeChild(this);
            // so here I will throw a event.
            Model_1.Model.eventHub.publish("register_event_", { userId: userId, email: email, pwd: pwd, repwd: repwd }, true);
        };
    }
}
