...
export class GroupManager extends HTMLElement {
    ...
    constructor() {
        ...
        let createRoleBtn = this.shadowRoot.querySelector("#create-group-btn")
        createRoleBtn.onclick = () => {
            ...
            if (panel == undefined) {
                ...
                createRoleButton.onclick = ()=>{
                    ...
                    .then(rsp => {
                        ApplicationView.displayMessage("Role " + groupId + " was created!", 3000)
                        panel.parentNode.removeChild(panel)
                        displayGroups()
                    }).catch(err => {
                        console.log(err)
