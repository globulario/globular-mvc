...
* @stability 1
*/
export function createChildElement(parent, node) {
...
* @stability 1
*/
export function createElementFromXml(parent, xml) {
...
* @stability 0
*/
export function createElementFromHtml(parent, html) {
...
export class Element {
  constructor(parent, params, callback, appendFront) {
    /**
  ...
  * @param {any} e The element to append. It can be an existing element, or a list of element properties.
  * @returns {Element}
  ...
  * @stability 2
  */
  getChildsByClassName(className, childs) {
    var keys = Object.keys(this.childs),
      i = 0,
      len = keys.length,
      found = null;
  ...
  * @stability 1
  */
  animate(keyframe, time, endAnimationCallback, transition, fillMode, iteration) {
